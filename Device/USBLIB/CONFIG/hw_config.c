...
void USBWakeUp_IRQHandler(void) __attribute__((naked));
void USB_LP_CAN1_RX0_IRQHandler(void) __attribute__((naked));

/*******************************************************************************
 * @fn        USBWakeUp_IRQHandler
 *
 * @brief     Wrapper function for USBWakeUp_IRQHandler_Real
 *
 * @return    None
 */
void USBWakeUp_IRQHandler(void)
{
	__asm volatile ("call USBWakeUp_IRQHandler_Real; mret");
}

/*******************************************************************************
 * @fn        USBWakeUp_IRQHandler_Real
 *
 * @brief     This function handles USB wake up exception.
 *
 * @return    None
 */
void USBWakeUp_IRQHandler_Real(void)
{
 ...
 *
 * @brief        Wrapper function for USB_LP_CAN1_RX0_IRQHandler_Real
 *
 * @return None
 */
void USB_LP_CAN1_RX0_IRQHandler(void)
{
	__asm volatile ("call USB_LP_CAN1_RX0_IRQHandler_Real; mret");
}

/*******************************************************************************
 * @fn           USB_LP_CAN1_RX0_IRQHandler_Real
 *
 * @brief        This function handles USB exception.
 *
 * @return None
 */
void USB_LP_CAN1_RX0_IRQHandler_Real(void)
{
	USB_Istr();
}
